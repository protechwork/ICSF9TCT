...
namespace ICSF9TCT.Models
{
    ...
    public class PurReqBodyData
    {
        public int Body__Id { get; set; }
        public int Item__Id { get; set; }
        public int Unit__Id { get; set; }
        public decimal Stock_Available { get; set; }
        public decimal Quantity { get; set; }
        public decimal Rate { get; set; }
        public decimal Gross { get; set; }
        ...
        public string PartyItemDesc { get; set; }
